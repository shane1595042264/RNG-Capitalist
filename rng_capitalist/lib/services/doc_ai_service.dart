// lib/services/doc_ai_service.dart - AI-Powered Document Analysis Service
import 'dart:io';
import 'dart:convert';
...
class DocAIService {
  static final DocAIService _instance = DocAIService._internal();
  factory DocAIService() => _instance;
  DocAIService._internal();
